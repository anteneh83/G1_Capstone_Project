...
const SingleBlog = () => {
  ...
  return (
    <div>
      ...
      >
        <Hero className="items-center" title="single blog" link={`singleblog`}>
            ...
            {categories.map((name, index) => (
              <div key={index} className="mb-6">
                <div className="flex items-center">
                  <img src={ArrowIcon} alt="Arrow" className="w-[19px] mr-6" />
          ...
          <div className="bg-black rounded-xl p-10">
            ...
            <div className="mt-8 space-y-5">
              <div className="flex items-center justify-center gap-4">
                <img src={PhoneIcon} alt="Phone" className="w-[19px]" />
                <span className="text-white text-[18px]">+62 6943 6956</span>
              </div>
              <div className="flex items-center justify-center gap-4">
                <img src={GmailIcon} alt="Email" className="w-[22px]" />
